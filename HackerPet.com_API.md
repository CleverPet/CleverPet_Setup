# This file was copied from the HackerPet.com API documentation
...
If you've not done so already, please visit hackerpet.com

Getting started
Along with a port of CleverPet's complete original training curriculum, hackerpet exists as a library on the Particle platform..
...
setup()
Within the setup function make sure to initialize the Hub, and pass it the name of your challenge.

This name will be used in the reporting. If you just pass it FILE it will use the current file name.
...
// EXAMPLE USAGE
hub.RetractTray();
Retract the tray (for use with PresentFoodtreat(0))
...
Make sure when this functionn is called the touchpads aren't in use. This will reset the lights and touches won't be registered.
(see Run function implementation for use)
